...
class MaintenanceGroupResponse {
  MaintenanceGroupResponse({
    this.id,
    this.markEdit,
    this.msg,
    this.msgType,
  ...
  static List<MaintenanceGroupResponse> fromList(dynamic json) => List.from(json.map((e) => MaintenanceGroupResponse.fromJson(e)));

  factory MaintenanceGroupResponse.fromJson( dynamic json) => MaintenanceGroupResponse(
