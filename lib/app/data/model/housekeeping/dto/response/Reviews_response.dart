...
class ReviewsResponse {
  ReviewsResponse({
    ...
    this.reviewHouseKeepingDtoList,
  ...
  List<ReviewModel>? reviewHouseKeepingDtoList;
  ...
  factory ReviewsResponse.fromJson( dynamic json) => ReviewsResponse(
    ...
    reviewHouseKeepingDtoList: json["reviewHouseKeepingDTOList"] == null ? null : List<ReviewModel>.from(json["reviewHouseKeepingDTOList"].map((x) => ReviewModel.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "reviewHouseKeepingDTOList": reviewHouseKeepingDtoList == null ? null : List<dynamic>.from(reviewHouseKeepingDtoList!.map((x) => x.toJson())),
