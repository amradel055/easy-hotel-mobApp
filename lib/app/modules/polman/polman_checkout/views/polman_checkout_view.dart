...
class PolmanCheckoutView
    extends GetView<PolmanCheckoutController> {
  const PolmanCheckoutView({Key? key}) : super(key: key);
      ...
      appBar: AppBar(
        ...
        title: Column(
          children: [
            ...
            TextWidget(AppStrings.polmanService,size: 15,textColor: AppColors.appGreyDark,)
          ],
        ),
      ),
        body: Container(
