          ...
          child: Column(
            children: [
              for(int i = 0 ; i <controller.spa!.offersDTOList!.length ; i++)
                SpaReservationPackage(controller.spa!.offersDTOList![i].name! , controller.spa!.offersDTOList![i].name! , controller.spa!.offersDTOList![i].image , controller.spa!.offersDTOList![i].offersDetailsDTOList![0].spaItemId )
            ],
          ),
        ),
