...
class OrderWidget extends GetView<OrderWidget> {
  const OrderWidget(this.price, this.id, this.image, this.title, this.subtitle,   {Key? key}) : super(key: key);
                        ...
                        child: SizedBox(width: size.width*.6,
                          child: Column(
                            ...
                            children:   [
                              ...
                              TextWidget("${DateTime.now().toString()}",textColor: Colors.grey,size: 10,weight: FontWeight.bold,),
                              Expanded(
